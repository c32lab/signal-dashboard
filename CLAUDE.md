...
## ⛔ 绝对禁止
- **不准删除已有页面或功能** — 所有页面（含 /predict、/advanced/chain）都是正式功能
- **不准把代码"移到其他项目"** — predict 代码属于 signal-dashboard，不准拆分
- **不准改端口** — dev :3080，signal API :18810，predict API :18801
- 违反以上任何一条 = 严重事故（RCA-011b 教训：2be7610 误删 predict 全部代码）

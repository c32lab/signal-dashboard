        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-4 pt-2">
            <button
              ...
              className="px-4 py-2 min-h-[44px] text-sm bg-gray-800 text-gray-300 rounded-lg hover:bg-gray-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              Prev
            </button>

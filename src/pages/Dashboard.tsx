...
import type { BiasAlert, BiasResponse, CollectorHealthResponse, Decision, HealthResponse, StatusResponse } from '../types'
...
function DecisionDistribution({ decisions }: { decisions: Decision[] }) {
  if (!decisions.length) {
    return (

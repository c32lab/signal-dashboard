...
export default function DecisionRow({
  ...
  return (
    <>
      <tr
        className="border-t border-gray-800 hover:bg-gray-900/80 transition-colors cursor-pointer select-none"
        onClick={onToggle}
      >
      ...
      {isExpanded && (
        <DecisionDetail rawJson={d.raw_json} colSpan={COL_COUNT} />
      )}
    </>
  )
}

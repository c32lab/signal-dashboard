...
test.describe('Trading Dashboard Page', () => {
  ...
  test('shows trading-related heading or content', async ({ page }) => {
    const hasHeading = await page.getByText(/trad/i).first().isVisible().catch(() => false)

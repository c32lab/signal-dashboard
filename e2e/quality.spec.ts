...
test.describe('Quality Tracker Page', () => {
  ...
  test('shows quality-related heading or content', async ({ page }) => {
    // Page should show a heading or loading state
    const hasHeading = await page.getByText(/quality|signal/i).first().isVisible().catch(() => false)
